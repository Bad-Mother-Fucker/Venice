#
#  Be sure to run `pod spec lint Venice.podspec' to ensure this is a
...
Venice provides UIView subclass which reacts to screen recording and screen mirroring events. It also provides an observer to those events giving a way to react properly if you need to.
  ...
  spec.author             = { "Michele De Sena" => "micheledes1296@gmail.com" }
  # Or just: spec.author    = "Michele De Sena"
  # spec.authors            = { "Michele De Sena" => "micheledes1296@gmail.com" }
   spec.social_media_url   = "https://twitter.com/micheledes1296"
  ...
  spec.source       = { :git => "https://github.com/Bad-Mother-Fucker/Venice.git", :tag => "#{spec.version}" }
